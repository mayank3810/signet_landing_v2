...
function Pricing() {
    ...
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="Signet pricing, pricing packages, choose the right plan"
        />
                    ...
                    <table className="table text-center">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className="ico-15 ">1000 per month</td>
                          <td className="ico-15 ">5000 per month</td>
                          <td className="ico-15 ">Unlimited</td>
                        </tr>
