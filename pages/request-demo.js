...
function RequestDemo() {
    ...
    <>
      <Head>
        ...
        <meta
          name="title"
          content="Schedule a Demo | Book a Meeting | Request a Free Trial"
        />
        <meta
          name="description"
        ...
        <meta
          property="og:url"
          content="https://www.signettags.com/request-demo"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="Schedule a Demo or Request a Free Trial with Signet Tags"
        />
        <meta
          property="og:description"
          content="Request a demo or free trial to experience our solutions. Schedule a meeting with us today."
        />
        ...
        <link
          rel="canonical"
          href="https://www.signettags.com/request-demo"
          key="canonical"
        />
          ...
          <div className="row">
            <div className="col-12 text-center mt-50">
              <h1 style={{ lineHeight: "1.5" }} className="text-white">
                Looking to explore how Signet Tags can help your company?
              </h1>
              <h3 className="text-white pb-3">Schedule a Demo to find out.</h3>
            </div>
