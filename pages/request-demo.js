...
function RequestDemo() {
	...
	const submitForm = async (e) => {
		...
		if (name.data !== '' && email.data !== '' && phone.data !== '' && phoneCode.data !== '' && validateEmail(email.data) && email.data !== '') {
			setLoading(true);
			...
			const rawResponse = await fetch(process.env.NEXT_PUBLIC_API_URL + 'general/email/contact', {
				...
				body: JSON.stringify({
					...
					pageName: 'Request a Demo - Signet Tags',
					postedOn: new Date(),
		...
		<>
			...
			<section id="contacts-2" className="bg-black content-3 wide-60 content-section division">
				<div className="container">
					<div className="row">
						<div className="col-12 text-center mt-40 mb-40">
							<h1 style={{ lineHeight: '1.5' }} className="text-white">
								Schedule a Demo
							</h1>
							<h3 className="text-white pb-3"> Try Signet Tags solutions today.</h3>
						</div>
						<div className="col-12">
							{/* CONTACT FORM */}
							<div className="row justify-content-center">
								<div className="col-12 col-lg-6 col-mg-6 col-xl-6  d-flex" style={{ alignItems: 'center' }}>
									<img
										className="img-fluid "
								...
								<div className="col-12 col-lg-6 col-mg-6 col-xl-6">
									<div className="form-holder">
										<form name="contactform" className="row contact-form">
											...
											<div className="col-md-12 mb-30">
												...
												<div class="input-group">
													...
													<input
														...
														className="form-control name"
														value={phone.data ?? ''}
														onChange={(e) => setPhone({ data: e.target.value, error: false })}
													/>
												</div>
											...
											<div className="col-md-12 mb-30">
												<p className="text-white">Explain your requirements in detail: </p>
											...
											{/* Contact Form Button */}
											<div className="col-md-12 mt-15 form-btn text-right">
												<button onClick={submitForm} className="btn btn-orange-red tra-white-hover w-100">
