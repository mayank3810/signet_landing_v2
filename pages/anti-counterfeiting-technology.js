...
import HologramQuote from '@/components/Home/HologramQuote';
...
<Head>
				...
				<meta name="title" content="Anti counterfeiting technology: Brand Protection with QR codes & NFC | Signet Tags" />
				<meta
					name="description"
					content="Protect your brand with Signet Tags' brand protection solutions. "
				/>
				<meta
					name="keywords"
					content="brand protection solutions, anti counterfeiting technology, anti counterfeit solutions, anti counterfiet"
				/>

				{/* <!-- Open Graph / Facebook --> */}
				<meta property="og:site_name" content="Signet Tags" />
				<meta property="og:url" content="https://www.signettags.com/anti-counterfeiting-technology" />
				...
				<meta name="twitter:url" content="https://www.signettags.com/anti-counterfeiting-technology" />
				...
				<link rel="canonical" href="https://www.signettags.com/anti-counterfeiting-technology" key="canonical" />
				<title>Digital Hologram Seal: Secure Brand Protection | Signet Tags</title>
          ...
          <div className="row d-flex align-items-center">
            <div className="col-md-8 col-lg-8">
              <div className="hero-20-txt white-color">
				...
				Anti-counterfeiting technology for complete brand protection.
                </h1>
				
               <p>
			   Signet tags in an integrated and scalable solution to authenticate products using QR, NFC and Blockchain
			   </p>
