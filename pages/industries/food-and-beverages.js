  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href="https://www.signettags.com/industries/food-and-beverages"
          key="canonical"
        />
        <meta
          name="title"
          content="Protect your Food and Beverages & Engage Your Consumers Signet Tags"
        />
        <meta
          name="description"
        ...
        <meta
          property="og:url"
          content="https://www.signettags.com/industries/food-and-beverages"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="Protect food, engage consumers with Signet tags"
        />
        <meta
          property="og:description"
          content=" Secure food, drinks with tamper-proof tech."
        />
              ...
              <div className="row d-flex align-items-center">
                ...
                <div className="col-md-7 col-lg-6">
                  <div className="txt-block right-column wow fadeInLeft">
                    {/* Title */}
                    <h2 className="h2-xs">
                      Authenticity solution for Food and Beverages
                    </h2>
                    {/* Text */}
                    <p className="p-lg">
                      Authenticity is a critical issue in the food and beverage
                      industry, as consumers rely on the authenticity of the
                      products they buy. Using Signet Tags Consumers can
                      identify instantaneously food and beverages authenticity
                      with a tap of their smartphone, using a direct NFC
                      connection.
                    </p>
                    ...
                    <p className="p-lg">
                      ...
                      Follow each product, and enable customers and third
                      parties to read the product history at any time.
                    </p>
                  </div>
                </div>
                {/* END TEXT BLOCK */}
            ...
            <div className="row justify-content-center">
              <div className="col-md-10 col-lg-8">
                <div className="section-title title-02 mb-60">
                  ...
                  <p className="p-xl">
                    Tag your premium product with a unique tamper-proof ID that
                    tracks the entire product journey and protect against
                    fraudulent refilling. Provide customers with product
                    assurance via secure physical-digital seals and tamper-proof
                    technology. Follow each product, and enable customers and
                    third parties to read the product history at any time.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="row row-cols-1 row-cols-md-3">
                ...
                <div className="col">
                  <div className="fbox-8 mb-40 wow fadeInUp">
                    ...
                    {/* Text */}
                    <p className="p-lg">
                      Provide customers with product assurance via secure
                      physical-digital seals and tamper-proof technology.
                    </p>
                  </div>
                </div>
                {/* FEATURE BOX #2 */}
                <div className="col">
                  <div className="fbox-8 mb-40 wow fadeInUp">
                    ...
                    {/* Text */}
                    <p className="p-lg">
                      Track your products until the final customer. Capture
                      valuable marketing insights and consented first-party data
                    </p>
                  </div>
                </div>
                {/* FEATURE BOX #3 */}
                ...
                <div className="txt-block left-column wow fadeInRight">
                  ...
                  <ul className="simple-list">
                    <li className="list-item">
                      <p className="p-lg">
                        Our technology can be used to create a tamper-proof
                        record of a product's journey from the source to the end
                        consumer. This can help to ensure the authenticity of
                        the product and provide transparency to consumers.
                      </p>
                    </li>
                    <li className="list-item">
                      <p className="p-lg">
                        By implementing a robust product traceability system,
                        food and beverage companies can track the entire journey
                        of the product from the source to the end consumer. A
                        traceability system allows for the identification and
                        isolation of any issues that may arise in the supply
                        chain.
                      </p>
                    </li>
                  </ul>
                ...
                <div className="col-md-7 col-lg-6">
                  ...
                  >
                    ...
                    <ul className="simple-list">
                      <li className="list-item">
                        <p className="p-lg">
                          Entice new and existing consumers to buy more by
                          offering them airtime, merchandise, redeemable loyalty
                          points, and grand prizes (raffle) for purchase
                        </p>
                      </li>

                      <li className="list-item">
                        <p className="p-lg">
                          Asides the fact that you can automatically acquire
                          consumer contacts, Signet Tags also helps you collect
                          insights directly from your consumers using short
                          intuitive surveys they take as part of their
                          participation in your campaigns
                        </p>
                      </li>
                    </ul>
                  </div>
