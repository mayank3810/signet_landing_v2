...
function Agriculture() {
  ...
  return (
    <>
      <Head>
        <title>
          Signet Tags - Traceability Solution for Agriculture Industry
        </title>
        <link
          rel="canonical"
          href="https://www.signettags.com/industries/agriculture"
          key="canonical"
        />
        <meta
          name="title"
          content="Traceability Solution for Agriculture Industry with Signet Tags"
        />
        <meta
          name="description"
        ...
        <meta
          property="og:url"
          content="https://www.signettags.com/industries/agriculture"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="Agricultural traceability with Signet tags"
        />
        <meta
          property="og:description"
          content="Ensure authenticity of agricultural products with Signet Tags."
        />
              ...
              <div className="row d-flex align-items-center">
                ...
                <div className="col-md-7 col-lg-6">
                  <div className="txt-block right-column wow fadeInLeft">
                    ...
                    {/* Text */}
                    <p className="p-lg">
                      Agricultural tracing and protection is important for many
                      reasons. It helps ensure the quality of our food, protects
                      our farmers and ranchers, and helps keep our environment
                      healthy. Our patent pending NFC tag leverages encrypted
                    ...
                    <p className="p-lg">
                      Our app or a direct NFC connection grants farmers instant
                      access to product characteristics, integrity and proof of
                      authenticity.
                    </p>
                  </div>
                </div>
            ...
            <div className="row justify-content-center">
              <div className="col-md-10 col-lg-8">
                <div className="section-title title-02 mb-60">
                  ...
                  <p className="p-xl">
                    The rapid growth in population and the consequent increase
                    of the food demand made the agricultural market reach the
                    size of 250.5 billion in 2020. It is estimated that between
                    10% and 25% of products for agriculture on the market are
                    counterfeited.
                  </p>
                </div>
              </div>
            ...
            <div className="row d-flex align-items-center">
              ...
              <div className="col-md-7 col-lg-6 order-last order-md-2">
                <div className="txt-block left-column wow fadeInRight">
                  {/* Title */}
                  <h3 className="h2-xs">
                    Illegally produced products for agriculture can pose several
                    risks, including:
                  </h3>
                  {/* List */}
                  <ul className="simple-list">
                    <li className="list-item">
                      <p className="p-lg">
                        Health risks: Illegally produced products may contain
                        harmful chemicals that can have serious health
                        consequences for humans, livestock, and the environment.
                        These chemicals can include pesticides, herbicides, and
                        fungicides that are banned or restricted in their use
                        due to their hazardous nature.
                      </p>
                    </li>
                    <li className="list-item">
                      <p className="p-lg">
                        Environmental risks: The use of illegal products can
                        lead to pollution of the soil, water, and air, which can
                        have harmful effects on the environment. This can lead
                        to reduced biodiversity, soil erosion, and contamination
                        of water sources.
                      </p>
                    </li>
                    <li className="list-item">
                      <p className="p-lg">
                        Economic risks: The use of illegal products can impact
                        the agricultural economy. Illegal products are often
                        sold at a lower price, which can make it difficult for
                        legitimate producers to compete. In addition, the use of
                        illegal products can result in lower yields and quality
                        of produce, which can impact the profitability of
                        farmers.
                      </p>
                    </li>
                  </ul>
