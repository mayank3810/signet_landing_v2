  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href="https://www.signettags.com/industries/cannabis"
          key="canonical"
        />
        <meta
          name="title"
          content="Signet Tags - NFC Tag Authentication for Cannabis"
        />
        <meta
          name="description"
        ...
        <meta
          property="og:url"
          content="https://www.signettags.com/industries/cannabis"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="NFC Tag Authentication for Cannabis with Signet Tags"
        />
        <meta
          property="og:description"
          content="Authenticate cannabis products with Signet Tags' NFC tags."
        />
      ...
      <PageTitle
        ...
        subtitle={
          "Open a new channel to engage, protect, and build trust with your customers."
        }
      />
              ...
              <div className="row d-flex align-items-center">
                ...
                <div className="col-md-7 col-lg-6">
                  <div className="txt-block right-column wow fadeInLeft">
                    ...
                    <p className="p-lg">
                      As the cannabis industry grows, it becomes increasingly
                      vulnerable to counterfeit products. People are becoming
                      more and more quality-conscious, and Signet technology
                      helps brands cater to that demand.
                    </p>
                  </div>
                </div>
                {/* END TEXT BLOCK */}
            ...
            <div className="row justify-content-center">
              <div className="col-md-10 col-lg-8">
                <div className="section-title title-02 mb-60">
                  ...
                  <p className="p-xl">
                    Our brand protection technologies create a new way to
                    engage, protect and build trust with your customers.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="txt-block left-column wow fadeInRight">
                  ...
                  <ul className="simple-list">
                    <li className="list-item">
                      <p className="p-lg">
                        Every cannabis product becomes digitally connected
                        opening a new marketing channel to engage your customers
                      </p>
                    </li>
                    <li className="list-item">
                      <p className="p-lg">
                        Smart packaging has shown to increase repeat purchases
                        and grow revenue.
                      </p>
                    </li>
                    <li className="list-item">
                      <p className="p-lg">
                        Capture valuable marketing insights and consented
                        first-party data
                      </p>
                    </li>
                    <li className="list-item">
              ...
              <div className="col-sm-5 col-md-4 col-lg-3 offset-sm-2 offset-md-3 offset-lg-2">
                <div className="statistic-block wow fadeInUp">
                  ...
                  <p className="p-lg mt-20">
                    annual sales increase in revenue, according to Gallup
                    research.
                  </p>
                </div>
              </div>
