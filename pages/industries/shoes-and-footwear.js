  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href="https://www.signettags.com/industries/shoes-and-footwear"
          key="canonical"
        />
        <meta
          name="title"
          content="Signet Tags Smart Packaging for Shoes and Footwear"
        />
        <meta
          name="description"
        ...
        <meta
          property="og:url"
          content="https://www.signettags.com/industries/shoes-and-footwear"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="NFC authentication for footwear with Signet Tags"
        />
        <meta
          property="og:description"
          content="Secure your footwear with Signet Tags against counterfeiting."
        />
              ...
              <div className="col-md-7 col-lg-6 order-last order-md-2">
                <div className="txt-block left-column wow fadeInRight">
                  ...
                  <ul className="simple-list">
                    ...
                    <li className="list-item">
                      <p className="p-lg">
                        Signet Tags has a range of smart packaging solutions to
                        fit any Cosmetics And Perfumes brand’s requirements
                        including cryptographic serialised QR codes, anti-copy
                        codes, or invisible smartphone readable technology.
                        Signet Tags solutions can be non-app based or app-based
...
export default ShoesAndFootwear;
