              ...
              <div className="row justify-content-center">
                <div className="col-12">
                  <div className="about-2-title">
                    ...
                    {/* Text */}
                    <p className="p-xl">
                      Pair your physical products, assets & collectibles with NFTs minted on the blockchain, Signet tags digital links & secure unclonable NFC tags to enable your products to participate in Web3
                    </p>
                  </div>
                </div>
              </div>{" "}
              ...
              <div className="row d-flex align-items-center">
                ...
                <div className="col-md-7 col-lg-6 order-last order-lg-2">
                  <div className="txt-block left-column wow fadeInRight">
                    ...
                    <p className="p-lg">
                      Protect your products against counterfeiting while gaining valuable business intelligence with Signet Tags SUN (Secure Unique NFC) Authentication Service.

                      Signet Tags-SUN is a highly available, secure, and scalable SaaS platform designed to verify the authenticity of NTAG 424 DNA NFC tags.
                      This NFC chip is a new revamped cost-effective and clone-resistant chip used for various retail and ticketing applications.
                    </p>
                ...
                <div className="col-md-7 col-lg-6">
                  <div className="txt-block right-column wow fadeInLeft">
                    <div className="txt-box mb-25">
                      ...
                      <p className="p-lg">
                        Signet Tags solution allies the best of both worlds as it gathers the incorruptible nature of blockchain and the practical functionality of hardware,
                        connecting the digital & the physical world by creating digital representations of valuable items.
                      </p>

                      <p className="p-lg">
                        Blockchain, an immutable & transparent database. No central point of trust, enabling peer-to-peer interaction, saving time & money.
                        Thanks to its many benefits, a real ecosystem composed of several different blockchain platforms has bloomed around this technology.
                      </p>
                    </div>
            ...
            <div className="row justify-content-center">
              <div className="col-lg-10 col-xl-8">
                <div className="section-title title-01 mb-70">
                  ...
                  {/* Text */}
                  <p className="p-xl">
                    Signet Tags can facilitate transactions simply by tapping an attached or embedded NFC tag with an NFC-enabled smartphone or tablet to securely communicate information.
                    This results in a frictionless authentication experience using a solution that fuels more powerful and dynamic Internet of Things applications.

                    Bring it all together. Hover over or click on each component for details of the solution.
