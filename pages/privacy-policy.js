            ...
            <div className="col-lg-10">
              ...
              <div className="terms-box mt-60">
                ...
                <p className="p-lg">
                  ...
                  <span className="txt-500">"Terms"</span>) tristique aliquet,
                  nisi libero suscipit diam, sed tempus ante nulla purus. Donec
                  dolor magna, a suscipit in magna dignissim, porttitor an
                  hendrerit diam. Nunc gravida ultrices faucibus. Aliquet lorem
                  purus, quis mollis nisi laoreet at vitae. Mauris consequat
                  tortor duis fermentum a massa
                </p>
                {/* Text */}
                <p className="p-lg">
