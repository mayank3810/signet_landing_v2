						...
						<div className="col">
							<div className="fbox-4 pl-25 mb-40 wow fadeInUp">
								...
								<div className="fbox-ico">
									<div className="ico-65 shape-ico dark-color">
										<img className="ico-bkg" src="/images/ico-bkg.png" alt="ico-bkg" />
										<img src="/images/industries/icons8-no-filling-100.png" alt="ico-bkg" />
									</div>
								</div>
								{/* Text */}
								<div className="fbox-txt">
									...
									{/* Text */}
									<p className="p-lg">Easily detect if the products have been tampered, using tag tamper detecting tags.</p>
								</div>
							</div>
						</div>
					</div>
