...
function Footer() {
	...
	return (
		<>
			...
			{successMessage && <div className="sucess-message animate__animated animate__fadeIn">Thank you for considering a demo with us.</div>}
								...
								<div className="row d-flex align-items-center">
									<div className="col-12">
										<div className="cta-4-txt">
											...
											<p className="pb-30">Please enter your email below to schedule a demo at your convenience.</p>
