...
function Footer() {
	...
	return (
		<>
			...
			{successMessage && <div className="sucess-message animate__animated animate__fadeIn">Thank you for subscribing to our Newsletter.</div>}
								...
								<div className="row d-flex align-items-center">
									<div className="col-12">
										<div className="cta-4-txt">
											<h5 className="h5-lg pt-15">Subscribe to our Newsletter</h5>
											<p className="pb-30">Only valuable content from us, promised!</p>
						...
						<div className="col-sm-6 col-md-3 col-lg-2">
							<div className="footer-links mb-40">
								...
								<ul className="foo-links text-secondary clearfix">
									...
									<li>
										<p className="p-md">
											<Link target={'_blank'} href={'https://app.signettags.com/'}>
												Login to app
											</Link>
										</p>
									</li>
						...
						<div className="col-sm-6 col-md-3 col-lg-2">
							<div className="footer-links mb-40">
								...
								<ul className="foo-links text-secondary clearfix">
									...
									<li>
										<p className="p-md">
											<Link target={'_blank'} href={'https://documenter.getpostman.com/view/24513031/2s93JtQPYp'}>
												API & Resources
											</Link>
										</p>
									</li>
