				...
				<div className="row d-flex align-items-center">
					<div className="col-md-6 col-lg-6">
						<div className="txt-block left-column wow fadeInRight">
							...
							<p className="p-lg">
								Engage with your consumers like never before with Signet Tags. With our innovative solution, you'll always be able to keep track of
								your customers and never lose touch again.
							</p>
							...
							<p className="p-lg">
								...
								connected to our dashboard, you can use those interactions to create valuable consumer profiles. These profiles will help your brand
