        ...
        <div className="row justify-content-center">
          <div className="col-lg-10 col-xl-8">
            <div className="section-title title-01 mb-70">
              ...
              {/* Text */}
              <p className="p-xl">
                Manufacturers can provide unique and customized digital
                experiences for their physical products. This allows customers
                to tap on the products and get more information about the
                product.
              </p>
            </div>
          </div>
                ...
                <div className="txt-box">
                  ...
                  <ul className="simple-list">
                    <li className="list-item">
                      <p className="p-lg">
                        AI enabled tool that allows brands to steer the entire
                        supply chain in real-time. A web portal to store and
                        verify products info, ensuring data transparency and
                        allowing digital audits, live alerts and advanced
                        analytics.
                      </p>
                    </li>
                    <li className="list-item">
                      <p className="p-lg">
                        Send push notifications and collect feedbacks on your
                        products with our advanced web portal.
                      </p>
                    </li>
                  </ul>
                </div>{" "}
