        ...
        <div className="row d-flex align-items-center">
          ...
          <div className="col-md-7 col-lg-6">
            ...
            >
              ...
              {/* Text */}
              <p className="p-lg">
                Use Signet Tags to ensure product authenticity and integrity,
                and direct NFC connection for quick and easy verification.
                Through Direct Interaction, reveal the product's history,
                features, and sustainability certifications.
              </p>
              {/* Text */}
              <p className="p-lg">
                NFC and Blockchain Technology together bring a stable approach
                to physical goods authentication. Encourage informed consumer
                decision-making and prevent the entry of counterfeit goods into
                the market.
              </p>
              <p className="p-lg">
                Our solution outperforms QR Code and image recognition-based
                alternatives in speed and security. No need to download any
                apps.
              </p>
